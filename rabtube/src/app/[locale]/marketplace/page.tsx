              ...
              <Link key={p.id} href={`/marketplace/product/${p.id}`} className="block border rounded-lg overflow-hidden hover:shadow-lg transition-shadow bg-white">
                <div className="aspect-w-1 aspect-h-1 bg-gray-200">
                  {p.imageUrl ? (
                    ...
                    <div className="flex items-center justify-center h-48 bg-gray-100 text-gray-400">{t('noImage')}</div>
                  )}
                </div>
                <div className="p-4">
          ...
          <div className="space-y-4">
            {requests.length === 0 ? (
              <div className="text-center py-16 border rounded-xl bg-white shadow-sm">
                ...
                <h3 className="text-lg font-bold text-gray-900 mb-2">{t('emptyRequestsTitle')}</h3>
                <p className="text-sm text-gray-500 mb-6">{t('emptyRequestsDesc')}</p>
              ...
              requests.map(req => (
                <div key={req.id} className="border rounded-lg p-5 bg-white flex justify-between items-start">
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    <span className="text-xs text-gray-500 mt-1">{t('iNeedThisToo')}</span>
                  </div>
                </div>
              ))
            )}
