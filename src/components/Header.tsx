        ...
        {user ? (
          ...
          <>
            <button
              ...
              className="flex items-center gap-1.5 bg-slate-100 hover:bg-slate-200 text-slate-800 text-sm font-medium px-3 sm:px-4 py-1.5 rounded-full transition-colors"
            >
              <Upload size={16} />
              <span className="hidden sm:inline">{t('upload')}</span>
            </button>
