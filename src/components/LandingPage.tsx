...
export default function LandingPage() {
  ...
  const getUploadFeeRab = (priceRab: number): number => {
    // Phase 1: Upload Charge is 0 RAB
    return 0;
  };
  ...
  const uploadEarn = uploads * (25 + baseBonus);
  const viewEarn = Math.round(uploads * views * casePrice * 0.8);
  ...
  return (
    <div className="landing-page-upload-root">
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .landing-page-upload-root .hero-wrap { max-width: 800px; margin: 0 auto; width: 100%; display: flex; flex-direction: column; text-align: center; align-items: center; justify-content: center; position: relative; z-index: 1; }

        .landing-page-upload-root .eyebrow { font-size: 13px; font-weight: 600; letter-spacing: 3.5px; text-transform: uppercase; color: var(--teal); margin-bottom: 18px; display: flex; align-items: center; justify-content: center; gap: 8px; opacity: 0; animation: up .7s var(--ease) .05s forwards; }
        .landing-page-upload-root .eyebrow::before, .landing-page-upload-root .eyebrow::after { content: ''; width: 22px; height: 1px; background: var(--teal); }
        ...
        .landing-page-upload-root .hero-sub { font-size: 19px; line-height: 1.8; color: var(--off2); font-weight: 300; max-width: 550px; margin: 0 auto 40px; opacity: 0; animation: up .8s var(--ease) .32s forwards; }
        ...
        .landing-page-upload-root .reward-row { display: flex; justify-content: center; flex-wrap: wrap; gap: 8px; margin-top: 36px; opacity: 0; animation: up .8s var(--ease) .56s forwards; }
            ...
            <div className="reward-details">
              <div className="rd-card rv d1">
                <div className="rd-header">
                  ...
                  <span className="rd-rab" style={{color: 'var(--teal)'}}>+25~45 RAB</span>
                </div>
